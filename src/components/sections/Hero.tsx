...
import {githubs, linkedin} from "../../assets";
        ...
        <section className={`relative mx-auto h-screen w-full`}>
            ...
            >
                <div className="mt-5 flex flex-col items-center justify-center">
                    <div className="h-5 w-5 rounded-full bg-[#6699cc]"/>
                    <div className="violet-gradient h-40 w-1 sm:h-80"/>
                </div>

                <div>
                    <h1 className={`${styles.heroHeadText} text-white`}>
                        Hi, I'm <span className="text-[#6699cc]">{config.hero.name}</span>
                    </h1>
            ...
            <div className="absolute top-[320px] justify-center w-full sm:hidden flex gap-8">
                <a href="www.linkedin.com/in/andrew1211">
                    <img src={linkedin} alt="linkedin" className='h-10 w-10'/>
                </a>
                <a href="https://github.com/AndrewFrancisSE">
